...
function usePloy(number = 16) {
  ...
  function jumpPoints() {
    ...
    points.value = points.value.map((o) => {
      ...
      // fallback: return the original point if no closest found
      return o
    })
  }
...
<template>
  <div
    ...
    :style="{ filter: `blur(70px) hue-rotate(${hue}deg)`, backgroundColor: bgColor }"
    aria-hidden="true"
  >
    <div
      class="clip"
      :style="{ 
        background: `linear-gradient(to right, ${color1}, rgba(255, 255, 255, 0.1))`,
    ...
    <div
      class="clip"
      :style="{ 
        background: `linear-gradient(to left, ${color2}, rgba(255, 255, 255, 0.1))`,
    ...
    <div
      class="clip"
      :style="{ 
        background: `linear-gradient(to top, ${color3}, rgba(255, 255, 255, 0.1))`,
